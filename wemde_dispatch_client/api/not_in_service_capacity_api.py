...
class NotInServiceCapacityApi:
    ...
    def get_quantities(
        ...
        dispatch_interval_from: Annotated[Optional[StrictStr], Field(description="Format - date-time (as date-time in RFC3339).")] = None,
        dispatch_interval_to: Annotated[Optional[StrictStr], Field(description="Format - date-time (as date-time in RFC3339).")] = None,
    ...
    ) -> SwaggerNotInServiceCapacitiesRoot:
        """/quantities - GET
        ...
        :type x_market: str
        :param dispatch_interval_from: Format - date-time (as date-time in RFC3339).
        :type dispatch_interval_from: str
        :param dispatch_interval_to: Format - date-time (as date-time in RFC3339).
        :type dispatch_interval_to: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SwaggerNotInServiceCapacitiesRoot",
    ...
    @validate_call
    def get_quantities_with_http_info(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_from: Annotated[Optional[StrictStr], Field(description="Format - date-time (as date-time in RFC3339).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SwaggerNotInServiceCapacitiesRoot]:
        """/quantities - GET
    ...
    @validate_call
    def get_quantities_without_preload_content(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_from: Annotated[Optional[StrictStr], Field(description="Format - date-time (as date-time in RFC3339).")] = None,
    ...
    def _get_quantities_serialize(
        self,
        x_initiating_participant_id,
        x_market,
        dispatch_interval_from,
        dispatch_interval_to,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if dispatch_interval_to is not None:
            
            _query_params.append(('dispatchIntervalTo', dispatch_interval_to))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/notInServiceCapacity/quantities',
