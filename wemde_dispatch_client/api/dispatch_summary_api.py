...
class DispatchSummaryApi:
    ...
    @validate_call
    def get_api_v1_dispatchsummary_dispatchdata(
        self,
        ...
        _param = self._get_api_v1_dispatchsummary_dispatchdata_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SwaggerDispatchSummaryData",
    ...
    @validate_call
    def get_api_v1_dispatchsummary_dispatchdata_with_http_info(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SwaggerDispatchSummaryData]:
        """Retrieves the Dispatch Summary Data for Dispatch Run
    ...
    @validate_call
    def get_api_v1_dispatchsummary_dispatchdata_without_preload_content(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
    ...
    def _get_api_v1_dispatchsummary_dispatchdata_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dispatchSummary/dispatchData',
    ...
    @validate_call
    def get_api_v1_dispatchsummary_dispatchdataoutcomes(
        self,
        ...
        _param = self._get_api_v1_dispatchsummary_dispatchdataoutcomes_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SwaggerDispatchSummaryDataWithRange",
            '400': "SwaggerErrorResponse",
            '401': "SwaggerErrorResponse",
            '403': "SwaggerErrorResponse",
            '404': "SwaggerErrorResponse",
    ...
    @validate_call
    def get_api_v1_dispatchsummary_dispatchdataoutcomes_with_http_info(
        self,
        primary_dispatch_interval_from: Annotated[StrictStr, Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")],
        primary_dispatch_interval_to: Annotated[StrictStr, Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")],
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SwaggerDispatchSummaryDataWithRange]:
        """Retrieves Dispatch Summary Data from the Central Dispatch Process through a range of past Primary Dispatch Intervals
    ...
    @validate_call
    def get_api_v1_dispatchsummary_dispatchdataoutcomes_without_preload_content(
        self,
        primary_dispatch_interval_from: Annotated[StrictStr, Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")],
        primary_dispatch_interval_to: Annotated[StrictStr, Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")],
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
    ...
    def _get_api_v1_dispatchsummary_dispatchdataoutcomes_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dispatchSummary/dispatchDataOutcomes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_api_v1_dispatchsummary_predispatchdata(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
        ...
        _param = self._get_api_v1_dispatchsummary_predispatchdata_serialize(
            x_initiating_participant_id=x_initiating_participant_id,
            x_market=x_market,
            dispatch_interval_start_date=dispatch_interval_start_date,
            dispatch_interval_end_date=dispatch_interval_end_date,
    ...
    @validate_call
    def get_api_v1_dispatchsummary_predispatchdata_with_http_info(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
    ...
    @validate_call
    def get_api_v1_dispatchsummary_predispatchdata_without_preload_content(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
    ...
    def _get_api_v1_dispatchsummary_predispatchdata_serialize(
        self,
        x_initiating_participant_id,
        x_market,
        dispatch_interval_start_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dispatchSummary/preDispatchData',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_api_v1_dispatchsummary_weekaheaddispatchdata(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
        ...
        _param = self._get_api_v1_dispatchsummary_weekaheaddispatchdata_serialize(
            x_initiating_participant_id=x_initiating_participant_id,
            x_market=x_market,
            dispatch_interval_start_date=dispatch_interval_start_date,
            dispatch_interval_end_date=dispatch_interval_end_date,
    ...
    @validate_call
    def get_api_v1_dispatchsummary_weekaheaddispatchdata_with_http_info(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
    ...
    @validate_call
    def get_api_v1_dispatchsummary_weekaheaddispatchdata_without_preload_content(
        self,
        x_initiating_participant_id: Annotated[StrictStr, Field(description="The id of the Initiating Participant")],
        x_market: Annotated[StrictStr, Field(description="The id of the market")],
        dispatch_interval_start_date: Annotated[Optional[StrictStr], Field(description="Default date format: yyyy-MM-ddTHH:mm:ss+08:00. For request, the offset +08:00 is optional - api will by default treat incoming time as +08:00")] = None,
    ...
    def _get_api_v1_dispatchsummary_weekaheaddispatchdata_serialize(
        self,
        x_initiating_participant_id,
        x_market,
        dispatch_interval_start_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dispatchSummary/weekAheadDispatchData',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
