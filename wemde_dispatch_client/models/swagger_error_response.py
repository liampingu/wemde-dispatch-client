...
class SwaggerErrorResponse(BaseModel):
    """
    SwaggerErrorResponse
    """ # noqa: E501
    transaction_id: Optional[StrictStr] = Field(default=None, alias="transactionId")
    errors: Optional[List[ErrorStructure]] = None
    __properties: ClassVar[List[str]] = ["transactionId", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [ErrorStructure.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
