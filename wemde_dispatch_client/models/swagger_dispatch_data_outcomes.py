...
class SwaggerDispatchDataOutcomes(BaseModel):
    """
    SwaggerDispatchDataOutcomes
    """ # noqa: E501
    data: Optional[DispatchDataOutcomesData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DispatchDataOutcomesData.from_dict(obj["data"]) if obj.get("data") is not None else None,
