...
class SwaggerDSPDispatchInstructionsParticipantWise(BaseModel):
    """
    SwaggerDSPDispatchInstructionsParticipantWise
    """ # noqa: E501
    transaction_id: Optional[StrictStr] = Field(default=None, alias="transactionId")
    data: Optional[SwaggerDSPDispatchInstructionsParticipantWiseData] = None
    __properties: ClassVar[List[str]] = ["transactionId", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SwaggerDSPDispatchInstructionsParticipantWiseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
