...
class Energy(BaseModel):
    ...
    base_forecast_requirement: Union[StrictFloat, StrictInt] = Field(description="The total forecast requirement for the relevant Market Service (i.e. energy, regulationRaise,regulationLower) coming from Metrix.  This is also known as the Forecast Unscheduled Operational Demand (as per Tranche 6 changes).", alias="baseForecastRequirement")
    ...
    facilities: List[EnergyFacility] = Field(description="An array of Facilities with Real-Time Market Submissions for the relevant Market Service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facilities": [EnergyFacility.from_dict(_item) for _item in obj["facilities"]] if obj.get("facilities") is not None else None
        })
        return _obj
