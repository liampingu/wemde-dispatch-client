...
class SwaggerDispatchCaseDataWithRange(BaseModel):
    """
    SwaggerDispatchCaseDataWithRange
    """ # noqa: E501
    data: Optional[DispatchCaseDataWithRange] = None
    errors: Optional[List[Any]] = None
    warnings: Optional[List[Any]] = None
    infos: Optional[List[Any]] = None
    transaction_id: Optional[StrictStr] = Field(default=None, alias="transactionId")
    __properties: ClassVar[List[str]] = ["data", "errors", "warnings", "infos", "transactionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DispatchCaseDataWithRange.from_dict(obj["data"]) if obj.get("data") is not None else None,
