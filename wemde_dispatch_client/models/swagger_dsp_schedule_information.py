...
class SwaggerDspScheduleInformation(BaseModel):
    """
    SwaggerDspScheduleInformation
    """ # noqa: E501
    transaction_id: Optional[StrictStr] = Field(default=None, alias="transactionId")
    data: Optional[SwaggerGetDspScheduleInformationResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SwaggerGetDspScheduleInformationResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
