...
class SwaggerDispatchSolutionData(BaseModel):
    """
    SwaggerDispatchSolutionData
    """ # noqa: E501
    data: Optional[DispatchSolutionData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DispatchSolutionData.from_dict(obj["data"]) if obj.get("data") is not None else None,
