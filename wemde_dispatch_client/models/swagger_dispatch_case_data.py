...
class SwaggerDispatchCaseData(BaseModel):
    """
    SwaggerDispatchCaseData
    """ # noqa: E501
    data: Optional[DispatchCaseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DispatchCaseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
