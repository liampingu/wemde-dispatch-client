...
class InServiceQuantities(BaseModel):
    """
    InServiceQuantities
    """ # noqa: E501
    energy_injection_capacity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Energy Injection Capacity in MW", alias="energyInjectionCapacity")
    energy_withdrawal_capacity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Energy Withdrawal Capacity in MW", alias="energyWithdrawalCapacity")
    contingency_raise: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Contingency Raise Capacity in MW", alias="contingencyRaise")
    contingency_lower: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Contingency Lower Capacity in MW", alias="contingencyLower")
    regulation_raise: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Regulation Raise Capacity in MW", alias="regulationRaise")
    regulation_lower: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Regulation Lower Capacity in MW", alias="regulationLower")
    rocof: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="In-Service Rocof Capacity in MWs")
