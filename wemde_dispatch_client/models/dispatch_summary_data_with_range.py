...
class DispatchSummaryDataWithRange(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["primaryDispatchInterval", "dispatchInterval", "markets", "schedule", "facilityScheduleDetails", "trapeziumAdjustments", "prices"]
