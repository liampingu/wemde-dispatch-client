...
class DispatchInstructionsHistoryFilter(BaseModel):
    """
    DispatchInstructionsHistoryFilter
    """ # noqa: E501
    search_all: Optional[StrictBool] = Field(default=None, alias="searchAll")
    facility_id: Optional[StrictStr] = Field(default=None, alias="facilityId")
    from_date: Optional[datetime] = Field(default=None, alias="fromDate")
    to_date: Optional[datetime] = Field(default=None, alias="toDate")
    __properties: ClassVar[List[str]] = ["searchAll", "facilityId", "fromDate", "toDate"]
