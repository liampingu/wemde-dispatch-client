...
class NotInServiceCapacities(BaseModel):
    """
    NotInServiceCapacities
    """ # noqa: E501
    facility_code: Optional[StrictStr] = Field(default=None, alias="facilityCode")
    not_in_service_capacity: Optional[StrictInt] = Field(default=None, alias="notInServiceCapacity")
    __properties: ClassVar[List[str]] = ["facilityCode", "notInServiceCapacity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notInServiceCapacity": obj.get("notInServiceCapacity")
        })
        return _obj
