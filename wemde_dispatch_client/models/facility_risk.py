...
class FacilityRisk(BaseModel):
    ...
    facility_risk_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="facilityRiskValue")
    __properties: ClassVar[List[str]] = ["facilityCode", "facilityRiskValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facilityRiskValue": obj.get("facilityRiskValue")
        })
        return _obj
