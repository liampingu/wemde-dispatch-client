...
class SwaggerTradingDayReport(BaseModel):
    """
    SwaggerTradingDayReport
    """ # noqa: E501
    data: Optional[TradingDayReports] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": TradingDayReports.from_dict(obj["data"]) if obj.get("data") is not None else None,
