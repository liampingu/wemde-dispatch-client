...
class TestSwaggerDispatchDataOutcomes(unittest.TestCase):
    """SwaggerDispatchDataOutcomes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDispatchDataOutcomes:
        """Test SwaggerDispatchDataOutcomes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDispatchDataOutcomes`
        """
        model = SwaggerDispatchDataOutcomes()
        if include_optional:
            return SwaggerDispatchDataOutcomes(
                data = wemde_dispatch_client.models.dispatch_data_outcomes_data.DispatchDataOutcomesData(
                    dispatch_data_issue_id = '', 
                    solution_data = [
                        wemde_dispatch_client.models.swagger_dispatch_data_outcomes_solution_datum.SwaggerDispatchDataOutcomesSolutionDatum(
                            categories = '', 
    ...
    def testSwaggerDispatchDataOutcomes(self):
        """Test SwaggerDispatchDataOutcomes"""
