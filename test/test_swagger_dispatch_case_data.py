...
class TestSwaggerDispatchCaseData(unittest.TestCase):
    """SwaggerDispatchCaseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDispatchCaseData:
        """Test SwaggerDispatchCaseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDispatchCaseData`
        """
        model = SwaggerDispatchCaseData()
        if include_optional:
            return SwaggerDispatchCaseData(
                data = wemde_dispatch_client.models.dispatch_case_data.DispatchCaseData(
                    primary_dispatch_interval = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    dispatch_data_issue_id = '', 
                    case_data = [
                        wemde_dispatch_client.models.data.Data(
                            scenario = '', 
                            ...
                            unconstrained_forecast = [
                                wemde_dispatch_client.models.unconstrained_forecast_datum.UnconstrainedForecastDatum(
                                    facility_code = '', 
    ...
    def testSwaggerDispatchCaseData(self):
        """Test SwaggerDispatchCaseData"""
