...
class TestDispatchDataOutcomesData(unittest.TestCase):
    """DispatchDataOutcomesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DispatchDataOutcomesData:
        """Test DispatchDataOutcomesData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DispatchDataOutcomesData`
        """
        model = DispatchDataOutcomesData()
        if include_optional:
            return DispatchDataOutcomesData(
    ...
    def testDispatchDataOutcomesData(self):
        """Test DispatchDataOutcomesData"""
