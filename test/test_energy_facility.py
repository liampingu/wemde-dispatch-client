...
class TestEnergyFacility(unittest.TestCase):
    """EnergyFacility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnergyFacility:
        """Test EnergyFacility
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnergyFacility`
        """
        model = EnergyFacility()
        if include_optional:
