...
class TestDispatchSummaryData(unittest.TestCase):
    """DispatchSummaryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DispatchSummaryData:
        """Test DispatchSummaryData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DispatchSummaryData`
        """
        model = DispatchSummaryData()
        if include_optional:
            return DispatchSummaryData(
    ...
    def testDispatchSummaryData(self):
        """Test DispatchSummaryData"""
