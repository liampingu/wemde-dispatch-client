...
class TestDispatchCaseDataWithRange(unittest.TestCase):
    """DispatchCaseDataWithRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DispatchCaseDataWithRange:
        """Test DispatchCaseDataWithRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DispatchCaseDataWithRange`
        """
        model = DispatchCaseDataWithRange()
        if include_optional:
            return DispatchCaseDataWithRange(
    ...
    def testDispatchCaseDataWithRange(self):
        """Test DispatchCaseDataWithRange"""
