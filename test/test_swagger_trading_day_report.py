...
class TestSwaggerTradingDayReport(unittest.TestCase):
    """SwaggerTradingDayReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerTradingDayReport:
        """Test SwaggerTradingDayReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerTradingDayReport`
        """
        model = SwaggerTradingDayReport()
        if include_optional:
            return SwaggerTradingDayReport(
                data = wemde_dispatch_client.models.trading_day_reports.TradingDayReports(
    ...
    def testSwaggerTradingDayReport(self):
        """Test SwaggerTradingDayReport"""
