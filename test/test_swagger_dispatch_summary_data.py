...
class TestSwaggerDispatchSummaryData(unittest.TestCase):
    """SwaggerDispatchSummaryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDispatchSummaryData:
        """Test SwaggerDispatchSummaryData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDispatchSummaryData`
        """
        model = SwaggerDispatchSummaryData()
        if include_optional:
            return SwaggerDispatchSummaryData(
                errors = [
                    null
                    ],
                warnings = [
                ...
                transaction_id = '',
                data = wemde_dispatch_client.models.dispatch_instructions_summary_data.DispatchInstructionsSummaryData(
                    ...
                    dispatch_summary_data = [
                        wemde_dispatch_client.models.dispatch_summary_data.DispatchSummaryData(
    ...
    def testSwaggerDispatchSummaryData(self):
        """Test SwaggerDispatchSummaryData"""
