...
class TestRegulationRaise(unittest.TestCase):
    """RegulationRaise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegulationRaise:
        """Test RegulationRaise
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegulationRaise`
        """
        model = RegulationRaise()
        if include_optional:
            return RegulationRaise(
                market_service = '',
