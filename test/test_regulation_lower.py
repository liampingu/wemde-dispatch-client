...
class TestRegulationLower(unittest.TestCase):
    """RegulationLower unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegulationLower:
        """Test RegulationLower
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegulationLower`
        """
        model = RegulationLower()
        if include_optional:
            return RegulationLower(
                market_service = '',
