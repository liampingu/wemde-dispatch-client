...
class TestSwaggerDispatchSummaryDataWithRange(unittest.TestCase):
    """SwaggerDispatchSummaryDataWithRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDispatchSummaryDataWithRange:
        """Test SwaggerDispatchSummaryDataWithRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDispatchSummaryDataWithRange`
        """
        model = SwaggerDispatchSummaryDataWithRange()
        if include_optional:
            return SwaggerDispatchSummaryDataWithRange(
                errors = [
                    null
                    ],
                warnings = [
                ...
                transaction_id = '',
                data = wemde_dispatch_client.models.dispatch_instructions_summary_data_with_range.DispatchInstructionsSummaryDataWithRange(
    ...
    def testSwaggerDispatchSummaryDataWithRange(self):
        """Test SwaggerDispatchSummaryDataWithRange"""
