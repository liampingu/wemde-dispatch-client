...
class TestSwaggerDSPDispatchInstructionsData(unittest.TestCase):
    """SwaggerDSPDispatchInstructionsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDSPDispatchInstructionsData:
        """Test SwaggerDSPDispatchInstructionsData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDSPDispatchInstructionsData`
        """
        model = SwaggerDSPDispatchInstructionsData()
        if include_optional:
            return SwaggerDSPDispatchInstructionsData(
    ...
    def testSwaggerDSPDispatchInstructionsData(self):
        """Test SwaggerDSPDispatchInstructionsData"""
