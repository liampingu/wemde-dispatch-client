...
class TestSwaggerDispatchDataOutcomesSolutionDatum(unittest.TestCase):
    """SwaggerDispatchDataOutcomesSolutionDatum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDispatchDataOutcomesSolutionDatum:
        """Test SwaggerDispatchDataOutcomesSolutionDatum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDispatchDataOutcomesSolutionDatum`
        """
        model = SwaggerDispatchDataOutcomesSolutionDatum()
        if include_optional:
            return SwaggerDispatchDataOutcomesSolutionDatum(
                categories = '',
    ...
    def testSwaggerDispatchDataOutcomesSolutionDatum(self):
        """Test SwaggerDispatchDataOutcomesSolutionDatum"""
