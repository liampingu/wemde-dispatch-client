...
class TestDispatchCaseData(unittest.TestCase):
    """DispatchCaseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DispatchCaseData:
        """Test DispatchCaseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DispatchCaseData`
        """
        model = DispatchCaseData()
        if include_optional:
            return DispatchCaseData(
