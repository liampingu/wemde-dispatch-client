...
class TestSolutionDatum(unittest.TestCase):
    """SolutionDatum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SolutionDatum:
        """Test SolutionDatum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SolutionDatum`
        """
        model = SolutionDatum()
        if include_optional:
            return SolutionDatum(
                categories = '',
