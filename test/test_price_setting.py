...
class TestPriceSetting(unittest.TestCase):
    """PriceSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceSetting:
        """Test PriceSetting
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceSetting`
        """
        model = PriceSetting()
        if include_optional:
            return PriceSetting(
