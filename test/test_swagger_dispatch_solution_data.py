...
class TestSwaggerDispatchSolutionData(unittest.TestCase):
    """SwaggerDispatchSolutionData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwaggerDispatchSolutionData:
        """Test SwaggerDispatchSolutionData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwaggerDispatchSolutionData`
        """
        model = SwaggerDispatchSolutionData()
        if include_optional:
            return SwaggerDispatchSolutionData(
                data = wemde_dispatch_client.models.dispatch_solution_data.DispatchSolutionData(
    ...
    def testSwaggerDispatchSolutionData(self):
        """Test SwaggerDispatchSolutionData"""
