...
class TestDispatchInstructionsSummaryData(unittest.TestCase):
    """DispatchInstructionsSummaryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DispatchInstructionsSummaryData:
        """Test DispatchInstructionsSummaryData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DispatchInstructionsSummaryData`
        """
        model = DispatchInstructionsSummaryData()
        if include_optional:
            return DispatchInstructionsSummaryData(
    ...
    def testDispatchInstructionsSummaryData(self):
        """Test DispatchInstructionsSummaryData"""
