...
class TestDataWithRange(unittest.TestCase):
    """DataWithRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataWithRange:
        """Test DataWithRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataWithRange`
        """
        model = DataWithRange()
        if include_optional:
