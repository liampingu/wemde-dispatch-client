...
class TestContingencyRaise(unittest.TestCase):
    """ContingencyRaise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContingencyRaise:
        """Test ContingencyRaise
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContingencyRaise`
        """
        model = ContingencyRaise()
        if include_optional:
            return ContingencyRaise(
                market_service = '',
