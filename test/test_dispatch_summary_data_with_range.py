...
class TestDispatchSummaryDataWithRange(unittest.TestCase):
    """DispatchSummaryDataWithRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DispatchSummaryDataWithRange:
        """Test DispatchSummaryDataWithRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DispatchSummaryDataWithRange`
        """
        model = DispatchSummaryDataWithRange()
        if include_optional:
            return DispatchSummaryDataWithRange(
    ...
    def testDispatchSummaryDataWithRange(self):
        """Test DispatchSummaryDataWithRange"""
